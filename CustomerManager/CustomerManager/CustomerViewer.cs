...
namespace CustomerManager
{
    public partial class CustomerViewer : Form
    {
        ...
        private void CustomerViewer_Load(object sender, EventArgs e)
        {
            ...
            context.VipOrders.Add(new VipOrder { ProductName = "Avto", Quantity = 101, PurchaseDate = DateTime.Parse("10.01.2016"), status = "High" });
            context.SaveChanges();
        ...
        private void buttonEdit_Click(object sender, EventArgs e)
        {
            ...
            customer.Age= Convert.ToInt32(customer.Age);
