...
namespace DataAdapterWizard
{
    public partial class Form1 : Form
    {
        ...
        {
            DialogResult response = MessageBox.Show("The following error occured while Filling the DataSet:" + e.Errors.Message.ToString() + " Continue attempting to fill?", "Fill Error Encountered", MessageBoxButtons.YesNo);
